...
namespace RuffLife.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RuffLife.Data.Context.RuffLifeContext>
    {
        ...
        protected override void Seed(RuffLife.Data.Context.RuffLifeContext context)
        {
            ...
            {
                new Dog { Name = "Dota", Breed = "Jack Russell", Age = "7", Gender = 'F', Owner = context.Owners.FirstOrDefault(u => u.Username == "Andrea")},
                new Dog { Name = "Alba", Breed = "Jack Russell", Age = "2", Gender = 'F', Owner = context.Owners.FirstOrDefault(u => u.Username == "Nikola") },
                new Dog { Name = "Vau", Breed = "Labrador", Age = "5", Gender = 'M', Owner = context.Owners.FirstOrDefault(u => u.Username == "Mirko") }
            };
