...
namespace RuffLife.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RuffLife.Data.Context.RuffLifeContext>
    {
        ...
        protected override void Seed(RuffLife.Data.Context.RuffLifeContext context)
        {
            ...
            owners.ForEach(x => context.Owners.AddOrUpdate(_ => _.Username, x));
            context.SaveChanges();
            ...
            dogs.ForEach(x => context.Dogs.AddOrUpdate(_ => new { _.Owner, _.Name }, x));
            context.SaveChanges();
            ...
            walkers.ForEach(x => context.Walkers.AddOrUpdate(_ => _.Username, x));
            context.SaveChanges();
            ...
            walks.ForEach(x => context.Walks.AddOrUpdate(_ => new { _.Walker, _.Dogs, _.StartTime }, x));
            context.SaveChanges();
            ...
            reviewForWalkers.ForEach(x => context.ReviewsForWalkers.AddOrUpdate(_ => new { _.Walker, _.Owner }, x));
            context.SaveChanges();
            ...
            reviewForDogs.ForEach(x => context.ReviewsForDogs.AddOrUpdate(_ => new { _.Dog, _.Walker }, x));
            context.SaveChanges();
        }
    }
}
